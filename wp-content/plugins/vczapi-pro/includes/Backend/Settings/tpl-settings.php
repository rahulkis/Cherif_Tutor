...
<form method="POST" action="">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input id="registration_email" name="registration_email" type="checkbox" class="vczapi-admin-checkbox" <?php ! empty( $this->settings ) && ! empty( $this->settings['registraion_email'] ) ? checked( $this->settings['registraion_email'], 'on' ) : false; ?> />
        ...
        <tr valign="top">
            ...
            <td>
                <input id="vczapi-pro-hide-gcal-links" name="hide_ical_links" type="checkbox" class="vczapi-admin-checkbox" <?php ! empty( $this->settings ) && ! empty( $this->settings['hide_ical_links'] ) ? checked( $this->settings['hide_ical_links'], 'on' ) : false; ?> />
        ...
        <tr valign="top">
            ...
            <td>
                <input id="vczapi-pro-hide-gcal-links-for-not-purchased" name="hide_ical_links_woocommerce" type="checkbox" class="vczapi-admin-checkbox" <?php ! empty( $this->settings ) && ! empty( $this->settings['hide_ical_links_woocommerce'] ) ? checked( $this->settings['hide_ical_links_woocommerce'], 'on' ) : false; ?> />
        ...
        <tr valign="top">
            ...
            <td>
                <input id="vczapi-pro-inline-registration-form" name="inline_registration_form" type="checkbox" class="vczapi-admin-checkbox" <?php ! empty( $this->settings ) && ! empty( $this->settings['inline_registration_form'] ) ? checked( $this->settings['inline_registration_form'], 'on' ) : false; ?> />
        ...
        <tr valign="top">
            ...
            <td>
                <input id="create_user_on_registration" name="create_user_on_registration" type="checkbox" class="vczapi-admin-checkbox" <?php ! empty( $this->settings ) && ! empty( $this->settings['create_user_on_registration'] ) ? checked( $this->settings['create_user_on_registration'], 'on' ) : false; ?> />
