			...
			<div class="create-meeting-mw">
				<div class="gm-modal-header">
					<p class="gm-modal-title">
						<?php echo esc_html__( 'Add New Meeting', 'masterstudy-lms-learning-management-system-pro' ); ?>
					</p>
					<a href="#" class="gm-modal-close">
						<img src="<?php echo esc_url( STM_LMS_PRO_URL . '/assets/img/cancel.svg' ); ?>" alt="close window">
					</a>
				</div>
				...
				<div class="gm-modal-actions">
					<a href="" class="btn button-save create-meeting-mw-save"><?php echo esc_html__( 'Save Changes', 'masterstudy-lms-learning-management-system-pro' ); ?></a>
