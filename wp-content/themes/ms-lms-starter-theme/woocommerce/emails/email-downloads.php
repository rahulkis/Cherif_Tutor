				...
				<td class="td" style="text-align:<?php echo esc_attr( $text_align ); ?>;">
					...
					if ( has_action( 'woocommerce_email_downloads_column_' . $column_id ) ) {
						do_action( 'woocommerce_email_downloads_column_' . $column_id, $download, $plain_text );
						 ...
						 $downloaded_files=get_post_meta($download['product_id'],'_downloadable_files',true);
						...
						switch ( $column_id ) {
							...
							case 'download-file':
								?>
								<a href="<?php echo esc_url( $zoom_meeting ); ?>" class="woocommerce-MyAccount-downloads-file button alt"><?php echo esc_html( $download['download_name'] ); ?></a>
								<?php
								break;
