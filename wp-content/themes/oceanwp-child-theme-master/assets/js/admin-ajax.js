//jQuery("body").on("click", ".add_kids", function(e) {
        ...
        // if(first_name == "")
        // {
        //     jQuery("input[name='first_name']").after("<span>Please enter your kid’s name</span>");
        //     return false;
        // }
        // else{
        //     jQuery("input[name='first_name']").after("<span></span>");
        // }
        // if(age == "")
        // {
        //     jQuery(".select_age").after("<span>Please enter your kid’s age</span>");
        //     return false;
        // }
        // if(grade == "")
        // {
        //     jQuery(".select_grade").after("<span>Please enter your kid’s grade</span>");
        //     return false;
        // }
        ...
        //         jQuery("#dat_table tbody").prepend("<tr id="+kid_class+" class='show_data_table'><td> <img style='max-width: 100px;'' src="+kid_img+" alt=''></td><td class='tble_names'>"+first_name+"</td><td class='tble_ages'>"+age+"</td><td class='tble_grades'>"+grade+"</td><td onclick="+dl_kid+" class='delTxt tble_delete'>Delete</td><td class='btn EditBtn tble_edit'>Edit</td>  </tr>"); 
          ...
          submitHandler: function(form) {  
             ...
             jQuery.ajax(
            {
                ...
                success: function(msg){
                    ...
                    jQuery("#dat_table tbody").prepend("<tr id="+kid_class+" class='show_data_table'><td> <img style='max-width: 100px;'' src="+kid_img+" alt=''></td><td class='tble_names'>"+first_name+"</td><td class='tble_ages'>"+age+"</td><td class='tble_grades'>"+grade+"</td><td onclick="+dl_kid+" class='delTxt tble_delete'>Delete</td><td onclick="+edit_kid+" class='btn EditBtn tble_edit'>Edit</td>  </tr>"); 
                    jQuery("#table_kidPrfl").css("display", "block");         
                    jQuery(".add_kids4").remove();
    ...
    jQuery("#edit_kids4").validate({
      ...
      submitHandler: function(form) {  
        ...
        jQuery.ajax(
        {
            ...
            cache: false,
            url: ajaxurl,
            data: 'first_name=' + first_name + '&age=' + age + '&grade=' + grade + '&current_kid_id=' + current_kid_id + '&current_user_id=' + current_user_id + '&action=updatekid',
            success: function(msg){
